...
ds1307Configuration_t ds1307Configuration = {.hours = 0, .weekDay = 1, .amPm = DS1307_AM, .minutes = 0, .seconds = 0, .year = 0, .month = 0, .monthDay = 0, .squareWaveActivation = OFF, .squareWaveOffValue = LOW, .squareWaveFrequency = 0, .countingHalted = DS1307_COUNTING_RESUME, .timeFormat = DS1307_FORMAT_24_HOURS, .unusedBits = 0};
